...
import { executeAfterWait, getDocumentBody, getIFrameEl, getIFrameSrc, getRootEl, postMessageToParent, defaultParamsForPinboardEmbed, waitFor, } from '../test/test-utils';
...
describe('Unit test case for ts embed', () => {
    ...
    describe('Called Embed event status for start and end', () => {
        ...
        test('verify Customisations from viewConfig', async () => {
            ...
            expect(getIFrameSrc()).toContain(`customCssUrl=${customisationsView.style.customCSSUrl}`);
        });
    ...
    describe('Navigate to Page API', () => {
        ...
        test('when app is PinboardEmbed after navigateToPage function call, new path should be set to iframe', async () => {
            ...
            expect(getIFrameSrc()).toBe(`http://${thoughtSpotHost}/?embedApp=true&${defaultParamsForPinboardEmbed}&isLiveboardEmbed=true${defaultParamsPost}#/embed/${path}`);
        });
