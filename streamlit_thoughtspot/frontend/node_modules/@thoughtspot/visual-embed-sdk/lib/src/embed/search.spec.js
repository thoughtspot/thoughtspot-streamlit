...
import { executeAfterWait, getDocumentBody, getIFrameSrc, getRootEl, fixedEncodeURI, defaultParamsWithoutHiddenActions as defaultParams, } from '../test/test-utils';
...
describe('Search embed tests', () => {
    ...
    test('should add runtime filters', async () => {
        ...
        searchEmbed.render();
        await executeAfterWait(() => {
            expect(getIFrameSrc()).toBe(`http://${thoughtSpotHost}/v2/?${defaultParamsWithHiddenActions}&dataSources=[%22data-source-1%22]&searchTokenString=%5Bcommit%20date%5D%5Brevenue%5D&dataSourceMode=hide&useLastSelectedSources=false${prefixParams}&col1=city&op1=EQ&val1=berkeley#/embed/answer`);
        });
    });
