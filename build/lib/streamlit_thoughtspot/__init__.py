...
def thoughtspot_search_component(
    ...
    datasources=None,
    searchstring=None):
    """Create a new instance of "thoughtspot_search_component".
    ...
    component_value = _component_func(host=host,width=width,height=height,sso=sso,datasources=datasources,searchstring=searchstring)
