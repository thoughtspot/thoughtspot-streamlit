...
describe('Unit test for process data', () => {
    ...
    test('processDataInstance, when operation is GetChartWithData', () => {
        ...
        jest.spyOn(answerServiceInstance, 'getAnswerServiceInstance').mockReturnValue(answerService);
        expect(processDataInstance.processCustomAction(processChartData, thoughtSpotHost)).toStrictEqual(processChartData);
    });
    test('ProcessData, when Action is CustomAction', async () => {
        ...
        expect(processDataInstance.processEventData(EmbedEvent.CustomAction, processedData, thoughtSpotHost, null)).toStrictEqual(processedData);
    });
    test('ProcessData, when Action is non CustomAction', () => {
        const processedData = { type: EmbedEvent.Data };
        jest.spyOn(processDataInstance, 'processCustomAction').mockImplementation(async () => ({}));
        jest.spyOn(answerServiceInstance, 'getAnswerServiceInstance').mockImplementation(async () => ({}));
